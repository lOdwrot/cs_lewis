...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Library article with markdown content';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'C.S. Lewis book with external redirect';
    displayName: 'Book';
    pluralName: 'books';
    singularName: 'book';
  };
...
export interface ApiEncyclopediaPageEncyclopediaPage
  ...
  info: {
    description: 'Editable content for the public encyclopedia page';
    displayName: 'Encyclopedia Page';
    pluralName: 'encyclopedia-pages';
    singularName: 'encyclopedia-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGateGate extends Struct.CollectionTypeSchema {
  collectionName: 'gates';
  info: {
    description: 'Top-level thematic entry points';
    displayName: 'Gate';
    pluralName: 'gates';
    singularName: 'gate';
  };
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::gate.gate'> &
      Schema.Attribute.Private;
...
export interface ApiJourneyJourney extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A thematic journey through C.S. Lewis content';
    displayName: 'Journey';
    pluralName: 'journeys';
  ...
  attributes: {
    ...
    gates: Schema.Attribute.Relation<'manyToMany', 'api::gate.gate'>;
    image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLibraryPageLibraryPage extends Struct.SingleTypeSchema {
  collectionName: 'library_pages';
  info: {
    description: 'Editable content for the public Biblioteka page';
...
export interface ApiStepStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual step within a journey (text, podcast, or quiz)';
    displayName: 'Step';
    pluralName: 'steps';
    singularName: 'step';
  };
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      ['step.text-content', 'step.podcast-content', 'step.quiz-content']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    tags: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['text', 'podcast', 'quiz']> &
      Schema.Attribute.Required &
...
export interface ApiTermTerm extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Encyclopedia term related to C.S. Lewis';
    displayName: 'Term';
    pluralName: 'terms';
    singularName: 'term';
  };
